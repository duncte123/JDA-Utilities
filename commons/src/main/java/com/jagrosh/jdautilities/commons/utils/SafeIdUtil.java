 ...
 * {@link net.dv8tion.jda.internal.utils.MiscUtil#parseSnowflake(String) MiscUtil.parseSnowflake(String)}, a utility used in
...
public final class SafeIdUtil
{
     ...
     * {@link net.dv8tion.jda.internal.utils.MiscUtil#parseSnowflake(String) MiscUtil.parseSnowflake(String)}.
     * 
     * @param  id
    ...
    /**
     * Checks if the provided String ID is usable with {@link net.dv8tion.jda.internal.utils.MiscUtil#parseSnowflake(String) MiscUtil.parseSnowflake(String)}.
     * 
     * @param  id
     *         The String ID to be converted
     *         
